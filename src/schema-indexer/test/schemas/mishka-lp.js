...
class Schema {
  async onInit(web3, data) {
    data.trackState();
    this.web3 = web3;
    this.batContract = this.web3.Contract(abi, mishkaLP);
  }
  ...
  async onBlock(blockNumber) {
    ...
    if (stateChanged) {
      try {
        const reserves = await this.batContract.methods.getReserves().call();
        console.log(reserves);
      } catch(e) {
        console.log(`exception at block: ${blockNumber}`);
        console.log(e)
      }
    }
  }
